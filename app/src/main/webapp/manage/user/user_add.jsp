...
<body class="user_add">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input name="accounts" id="accounts" type="text"
							class="layui-input" onblur="checkAccounts()">


					</div>
					<label class="layui-form-label DIV DIV"
						style="color: red; display: none" name='tishi' id='tishi'>账号已存在</label>
	...
	<script>
		...
		function checkAccounts() {
			...
			$.ajax({
				url : '/app/user/check_accounts.ajax',
				type : 'post',
				dataType : "json",
				data : {
