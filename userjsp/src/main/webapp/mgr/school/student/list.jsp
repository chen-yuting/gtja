...
<body>
        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label">入学时间(起)</label>
                        <div class="layui-input-block">
                            <input type="text" name="startTime" id="startTime" placeholder="请输入"
                                autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">入学时间(终)</label>
                        <div class="layui-input-block">
    ...
    <script>
        ...
        }).use(['index', '_school_student', 'table', 'laydate'], function () {
            var $ = layui.$
                , form = layui.form
                , table = layui.table
            ...
            var active = {
                batchdel: function () {
                    ...
                    checkData.forEach(function (element) {
                        istudent = {
                            istudent: element.istudent
                        }
                        istudents.push(istudent);
                    });
                    if (istudents.length != 0) {
