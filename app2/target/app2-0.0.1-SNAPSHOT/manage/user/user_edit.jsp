                ...
                <div class="layui-field-box" style="align: left;">
                    <div class="layui-form-item">
                        <div class="layui-input-inline">
                            <input name="iuser" id="iuser" type="hidden" value=${user.iuser } readonly="true"
                                class="layui-input">

                        </div>
                        <label class="layui-form-label DIV">账号</label>
                        <div class="layui-input-inline">
                            <input name="accounts" id="accounts" type="text" value=${user.accounts } readonly="true"
                                class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input name="position" id="position" type="text" class="layui-input" value=${user.department
                                }>
                        ...
                        <div class="layui-input-inline">
                            <input name="name" id="name" type="text" value=${user.name } readonly="true"
                                class="layui-input">
